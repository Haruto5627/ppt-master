...
Usage:
    python3 skills/word-rewrite/extract_office_images.py <file_or_dir> [...]
    python3 skills/word-rewrite/extract_office_images.py report.docx
    python3 skills/word-rewrite/extract_office_images.py ./docs --dir-name images

Examples:
    python3 skills/word-rewrite/extract_office_images.py 报告.docx
    python3 skills/word-rewrite/extract_office_images.py ./materials -r
