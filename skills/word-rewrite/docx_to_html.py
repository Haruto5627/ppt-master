...
Usage:
    python skills/word-rewrite/docx_to_html.py report.docx
    python skills/word-rewrite/docx_to_html.py report.docx --check

Examples:
    python skills/word-rewrite/docx_to_html.py 报告.docx
    python skills/word-rewrite/docx_to_html.py 报告.docx -o 报告.body.html
