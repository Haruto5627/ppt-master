...
| Accent | #A00000 | 完成、超前、正向 |
| Secondary accent | #C00000 | 风险、落后、待决策 |
| Body text | #222222 | 主体文本与关键数字 |
| Grid | #E8E8E8 | 背景网格 |
| Muted text | #6B6B6B | 注释与来源 |
| Blocking | #7A0000 | 明确阻塞与最高风险 |
...
- **Layout**: 左侧尺寸线框住 61.4%；右侧落后 3.8 点用标题红刻度标出，关键路径指向 hood 与边缘，不用卡片墙。
...
- **Layout**: 左主仪表总体完成；右四信号带：进展 / 能力 / 风险 / 决策，超前暗红、落后标题红。
...
- **Layout**: 六条水平完成率轨，按完成率降序；44% 与 39% 用标题红加长标注，22% 用虚线表示未到窗口。
